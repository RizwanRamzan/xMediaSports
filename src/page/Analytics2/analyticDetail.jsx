...
const AnalyticDetails = () => {
    ...
    return (
        <Card style={{ margin: "20px" }} title={<Link to="/analytics-2" style={{color:"#FF9A00"}} ><ArrowLeftOutlined style={{color:"#FF9A00"}} /> Back</Link>} extra={<img width={"40px"} src={storeCard?.icon ? storeCard?.icon : "/Flag-United-States-of-America.webp"} />}>
